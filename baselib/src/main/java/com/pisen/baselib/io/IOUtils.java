...
public class IOUtils {
    ...
    public static void copy(InputStream is, OutputStream os, OnProgressListener listener) throws IOException {
        int tempSize = 0;
        int downloadSize = 0;
        ...
        while (true) {
            ...
            os.write(buffer, 0, tempSize);
            downloadSize += tempSize;
            if (null == listener) {
                listener.onProgressUpdate(downloadSize);
            }
        }
    }
